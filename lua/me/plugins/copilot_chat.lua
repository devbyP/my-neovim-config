return {
	{
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>ccr", ":CopilotChatReset<CR>", { desc = "Copilot Chat Reset Current chat" })
			vim.keymap.set("n", "<leader>ais", ":CopilotChatStop<CR>", { desc = "Copilot Chat Stop current output" })
		end,
	},
}
