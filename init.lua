...
-- Determine how tab size
vim.opt.tabstop = 4

-- views can only be fully collapsed with the global statusline
vim.opt.laststatus = 3

-- Line wrap - character auto break new line (same line number) when overflow
vim.o.wrap = false
...
vim.keymap.set('n', '<leader>e', vim.diagnostic.open_float, { desc = 'Open diagnostic float window' })
...
vim.keymap.set('n', '<C-j>', ':move .+1<CR>', { silent = true })
